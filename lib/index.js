...
(module => {
	...
	const templateExtensionKey = 'templateExtension'
	...
	class HtmlWebpackScriptsPlugin {
		...
		constructor(options) {
			...
			if (templateExtensionKey in this._options) {
				templateAssetRegExp = _templateAssetRegExp(this._options[templateExtensionKey])
				delete this._options[templateExtensionKey]
